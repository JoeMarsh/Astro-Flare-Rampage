...
namespace AstroFlare
{
    public class Camera2D
    {
        ...
        public Camera2D(GraphicsDevice graphicsDevice, int worldWidth, int worldHeight)
        {
            _zoom = 1.0f;
            _rotation = 0.0f;
            //_pos = new Vector2(0, 0);
            _pos = new Vector2(graphicsDevice.Viewport.Width / 2.0f, graphicsDevice.Viewport.Height / 2.0f);
        ...
        public Matrix get_transformation(GraphicsDevice graphicsDevice, float parallax)
        {
            _transform =   
              Matrix.CreateTranslation(new Vector3(-_pos.X * parallax, -_pos.Y * parallax, 0)) *
