...
namespace AstroFlare
{
    class BugDagger2 : Enemy
    {
        ...
        public BugDagger2(SpriteSheet spriteSheet)
            : base(spriteSheet, 1)
        {
            ...
            this.baseTexture = new Sprite(Config.BugDagger2SpriteSheetBase);
...
//********************************
        ...
        protected override void Explode()
        {
            ...
            {
                GameNode node = null;
                node = new BugDagger3(Config.BugDagger3SpriteSheet);
