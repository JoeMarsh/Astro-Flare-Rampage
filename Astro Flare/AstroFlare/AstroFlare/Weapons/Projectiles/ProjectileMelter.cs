...
{
    class ProjectileMelter : Projectile
    {
        GameNode target;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (this.target != null)
            {
                if (!this.target.Dead && Vector2.Distance(this.target.Position, this.Position) < 200)
                {
                    ...
                    if (this.target == Player.Ship)
                        ...
                        this.Direction += targetDirection * 1f;
        ...
        public static void FireMissile(Vector2 direction, Vector2 position)
        {
            ...
            {
                Projectile p = new ProjectileMelter(Config.EnemyBulletSheet);
