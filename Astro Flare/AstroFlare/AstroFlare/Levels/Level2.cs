    ...
    class Level2
    {
        ...
        public Vector2 randomStartLocation(int side)
        {
            switch (side)
            {
                ...
                case 0:
                    return entryPosition = new Vector2(50, Config.Rand.Next(910));
                case 1:
                    return entryPosition = new Vector2(Config.Rand.Next(1550), 50);
                case 2:
                    return entryPosition = new Vector2(1550, Config.Rand.Next(910));
                case 3:
                    return entryPosition = new Vector2(Config.Rand.Next(1550), 910);
            }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            extraSpawnTimer += gameTime.ElapsedGameTime.TotalSeconds;
        ...
        void randomSpawner()
        {
            ...
            if (extraSpawnTimer > Config.Rand.Next(spawnMinTime, spawnMaxTime))
            {
                int random;
                GameNode node = null;
                ...
                if (difficulty > 1)
                {
                    random = Config.Rand.Next(0, 6);
                }
                else
                {
                    random = Config.Rand.Next(0, 5);
                }
