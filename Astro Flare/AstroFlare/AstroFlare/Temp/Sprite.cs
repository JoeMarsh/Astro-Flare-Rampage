...
namespace AstroFlare
{
    class SpriteOld
    {
        ...
        public SpriteOld(Vector2 location, Texture2D texture, Rectangle initialFrame, Vector2 velocity)
        {
        ...
        {
            spriteBatch.Draw(Texture, Center, Source, tintColor, rotation, new Vector2(frameWidth / 2, frameHeight / 2), 1.0f, SpriteEffects.None, 0.2f);
        }

        public virtual void Draw(SpriteBatch spriteBatch, float scale)
        {
            spriteBatch.Draw(Texture, Center, Source, tintColor, rotation, new Vector2(frameWidth / 2, frameHeight / 2), scale, SpriteEffects.None, 0.2f);
        }
