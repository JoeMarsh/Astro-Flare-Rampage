...
namespace AstroFlare
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        protected const int menuEntryPadding = 20;
        ...
        public Vector2 StartPosition = new Vector2(0f, 180f);
        public bool GameTitleEnabled = true;
        /// <summary>
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            //Vector2 position = new Vector2(0f, 180f);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Texture2D Title = ScreenManager.Title;
            ...
            if (GameTitleEnabled)
            {
                spriteBatch.Draw(Title, new Vector2(158, 70), Color.White);
            }
            //spriteBatch.Draw(Title, new Vector2(158, 100), Color.White);
