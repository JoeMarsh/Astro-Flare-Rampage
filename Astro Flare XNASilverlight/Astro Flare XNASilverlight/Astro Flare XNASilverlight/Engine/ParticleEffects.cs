...
namespace AstroFlare
{
    static class ParticleEffects
    {
        ...
        static public void Update(TimeSpan gameTime)
        {
            //gameTimer = gameTime;
            SecondsPassed = (float)gameTime.TotalSeconds; 
        ...
        static public void Update(TimeSpan gameTime, Camera2D cam, ref Matrix transform)
        {
            //gameTimer = gameTime;
            SecondsPassed = (float)gameTime.TotalSeconds;
