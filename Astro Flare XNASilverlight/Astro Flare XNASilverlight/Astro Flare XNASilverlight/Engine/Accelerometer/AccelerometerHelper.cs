...
namespace Microsoft.Phone.Applications.Common
{
    ...
    public class AccelerometerHelperReadingEventArgs : EventArgs
    {
      ...
      public AccelerometerReadingEventArgs OriginalEventArgs { get; set; }
    ...
    public sealed class AccelerometerHelper: IDisposable
    {
        ...
        /// </summary>
        private const double MaximumCalibrationTiltAngle = 90.0 * Math.PI / 180.0; // 20 deg inclination from non-calibrated axis max
        ...
        /// </summary>
        //ADAM: Made public and non-const:
        public static int SamplesCount = 25; // averaging and checking stability on 500ms
        ...
        private void sensor_ReadingChanged(object sender, AccelerometerReadingEventArgs e)
        {
            ...
            if (ReadingChanged != null)
            {
                ...
                readingEventArgs.OriginalEventArgs = e; // Added to original sample
