...
namespace AstroFlare
{
    ...
    /// </summary>  
    public class SpriteFontFloatScore
    {
        ...
        internal void UpdateAnimatedPosition(TimeSpan gameTime)
        {
            if (!this.Alive) return;

            this.LifeLeft -= gameTime.Milliseconds;
            this.SizeTimeLeft -= gameTime.Milliseconds;
        ...
        /// Project method of the GraphicsDeviceManager.</param>  
        internal void RecalculatePositionFromCamera(GraphicsDeviceManager graphics, Matrix cameraProjectionMatrix, Matrix cameraViewMatrix, TimeSpan gameTime)
        {
            if (!this.Alive) return;
            ...
            UpdateAnimatedPosition(gameTime);
        }
    ...
    /// </summary>  
    public class SpriteFontFloatScores : IEnumerable
    {
        #region Private Properties
        ...
        /// </summary>  
        /// <param name="gameTime">The gameTime value provided by the XNA framework in the game.Update method.</param>  
        internal void UpdateAllAnimatedPositions(TimeSpan gameTime)
        {
            bool restart;
            do
            {
        ...
        /// /// <param name="cmaeraViewMatrix">The Matrix of the View Matrix of the camera.  Used with the  
        /// Project method of the GraphicsDeviceManager.</param>  
        internal void RecalculateAllPositionsFromCamera(GraphicsDeviceManager graphics, Matrix cameraProjectionMatrix, Matrix cameraViewMatrix, TimeSpan gameTime)
        {
            foreach (AstroFlare.SpriteFontFloatScore floatScore in this)
            {
                floatScore.RecalculatePositionFromCamera(graphics, cameraProjectionMatrix, cameraViewMatrix, gameTime);
            }
        }
